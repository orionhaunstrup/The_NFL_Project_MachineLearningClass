...
def test_random_player():
    ...
    datacube_filename, chosen_player, career_length = (random.choice(PLAYER_POOL))
...
def test_full_SVM(num_experiments=500):
    ...
    if num_percentile_scores == 0:
        ...
        average_percentile_error = (total_percentile_error / num_percentile_scores)
...
def main():
    ...
    print()
    print()
    print("Testing RBF for best bin #")
    print()

    for bins in [2,3,4,5,6,7,8,9]:
        ...
        print()
        print("Mean Retirement Error =", round(retirement_error, 3))
        print("Mean Percentile Error =", round(percentile_error, 3))
