...
def main_silhouette_all_datacubes():

    K_MIN = 2
    K_MAX = 50

    for position_name, datacube_filename in DATACUBES.items():
        ...
        plt.title(
            f"{position_name} Silhouette Analysis"
        )
        ...
        plt.savefig(
            f"{position_name}_Silhouette_Analysis.png"
        )

        plt.close()


main_silhouette_all_datacubes()
